  ...
  createJSON: function(answers) {
    ...
    if(answers.dist) {
      ...
      json.paths.output = {
        ...
        uncompressed : path.normalize(answers.dist + '/component/'),
        compressed   : path.normalize(answers.dist + '/component/'),
  ...
  questions: {
    ...
    setup: [
      ...
      },
      {
        ...
        choices: [
          {
            name: 'Automatic (Use default locations and all component)',
            value: 'auto'
          },
          {
            name: 'Express (Set component and output folder)',
            value: 'express'
          },
          {
      ...
      },
      {
        type: 'checkbox',
        name: 'components',
        message: 'What component should we include in the package?',
      ...
      },
      {
        type: 'input',
        name: 'compressed',
        message: 'Where should we output compressed component?',
      ...
      },
      {
        type: 'input',
        name: 'uncompressed',
        message: 'Where should we output uncompressed component?',
